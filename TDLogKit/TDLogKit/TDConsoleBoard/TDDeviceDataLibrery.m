...
@interface TDDeviceDataLibrery()

@property (nonatomic, assign) DiviceType iDevice;

@end

@implementation TDDeviceDataLibrery

#pragma mark - Public Method

+(instancetype)sharedLibrery {
    static TDDeviceDataLibrery *_librery;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _librery = [[TDDeviceDataLibrery alloc] init];
...
static const NSString *iDeviceNameContainer[] = {
    ...
    [iPhone_SE]                 = @"iPhone SE",
    [Chinese_iPhone_7]          = @"iPhone 7",
    [Chinese_iPhone_7_Plus]     = @"iPhone 7 Plus",
    [American_iPhone_7]         = @"iPhone 7",
    [American_iPhone_7_Plus]    = @"iPhone 7 Plus",
    [Chinese_iPhone_8]          = @"iPhone 8",
    [Chinese_iPhone_8_Plus]     = @"iPhone 8 Plus",
    [Chinese_iPhone_X]          = @"iPhone X",
    [Global_iPhone_8]           = @"iPhone 8",
    [Global_iPhone_8_Plus]      = @"iPhone 8 Plus",
